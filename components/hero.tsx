  ...
  return (
    <section className="relative flex min-h-screen flex-col">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center px-4 pt-10 pb-16 text-center">
        ...
        <h1 className="mb-4 max-w-4xl text-pretty font-[family-name:var(--font-poppins)] text-3xl font-bold uppercase leading-[1.05] tracking-tight text-background md:text-5xl">
